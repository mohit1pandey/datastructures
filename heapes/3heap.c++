// basicallly it creates a heap with a given array we will call it build heap
// hear we will use it to only correct the heap at any point
...
int main(){
 ...
 int b_heap[8]={20,9,7,13,14,17,18,19};     
